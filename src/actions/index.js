...
const config = {
    apiKey: "AIzaSyDdQvb0wj24POJ7WVyU_Mo4g08t35X_3x4",
    authDomain: "homesafe-eb0af.firebaseapp.com",
    databaseURL: "https://homesafe-eb0af.firebaseio.com",
};
...
export function requestRandom(term = null) {
    return function (dispatch) {
        request.get(`http://api.giphy.com/v1/stickers/random?api_key=dc6zaTOxFJmzC&tag=oops`).then(response => {
            dispatch({
                type: REQUEST_GIFS,
                payload: response
            });
